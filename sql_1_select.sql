...
SELECT NAME AS nm , DISTRUCT AS dist FROM CITY WHERE COUNTRYCODE = 'arm';
#
...
SELECT DISTINCT COUNTRYCODE FROM CITY WHERE POPULATION = 10000; 
#
...
SELECT * FROM COUNTRY WHERE INDEPYEAR IS NOT NULL AND POPULATION > 1000000;
#
