...
SELECT SUM(Population) AS TotalPopulationBelow10000 FROM City WHERE Population < 10000;
#
...
SELECT c2.Name FROM City c1 JOIN City c2 ON c1.CountryCode = c2.CountryCode WHERE c1.Population = 122199 AND c2.Population != 122199;
#
